...
import { Sparkles, User, Mail, Lock, AlertCircle, Loader2, ArrowRight } from 'lucide-react';
...
export const Signup = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-dark-bg flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-purple-500/10 dark:bg-purple-500/20 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-10 left-10 w-80 h-80 bg-indigo-500/10 dark:bg-indigo-500/20 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center z-10 space-y-3">
        ...
        <h2 className="text-3xl font-extrabold text-gray-900 dark:text-white tracking-tight">
          Create your Career<span className="text-indigo-600 dark:text-indigo-400">AI</span> Account
        </h2>
        <p className="text-sm text-gray-500 dark:text-gray-400">
          Unlock personalized AI resume review, ATS optimization, and interview practice
        </p>
      </div>
        ...
        <div className="glass-card rounded-3xl p-8 shadow-2xl border border-gray-200 dark:border-gray-800">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 px-4 rounded-xl bg-gradient-to-r from-indigo-600 via-purple-600 to-indigo-500 text-white font-semibold text-sm shadow-lg shadow-indigo-500/25 hover:opacity-95 disabled:opacity-50 transition-all flex items-center justify-center space-x-2 mt-2"
            >
              {loading ? (
